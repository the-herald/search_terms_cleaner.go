...
const file_google_api_serviceusage_v1_serviceusage_proto_rawDesc = "" +
	"\n" +
	...
	"\x15EnableServiceResponse\x12=\n" +
	"\aservice\x18\x01 \x01(\v2#.google.api.serviceusage.v1.ServiceR\aservice\"\xcb\x02\n" +
	"\x15DisableServiceRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12<\n" +
	"\x1adisable_dependent_services\x18\x02 \x01(\bR\x18disableDependentServices\x12\x84\x01\n" +
	"\x1acheck_if_service_has_usage\x18\x03 \x01(\x0e2H.google.api.serviceusage.v1.DisableServiceRequest.CheckIfServiceHasUsageR\x16checkIfServiceHasUsage\"Y\n" +
	"\x16CheckIfServiceHasUsage\x12*\n" +
	"&CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04SKIP\x10\x01\x12\t\n" +
	"\x05CHECK\x10\x02\"W\n" +
	"\x16DisableServiceResponse\x12=\n" +
	"\aservice\x18\x01 \x01(\v2#.google.api.serviceusage.v1.ServiceR\aservice\"'\n" +
	...
	"\bservices\x18\x01 \x03(\v2#.google.api.serviceusage.v1.ServiceR\bservices\x12&\n" +
	...
	"serviceIds\"\x96\x02\n" +
	"\x1bBatchEnableServicesResponse\x12?\n" +
	"\bservices\x18\x01 \x03(\v2#.google.api.serviceusage.v1.ServiceR\bservices\x12a\n" +
	"\bfailures\x18\x02 \x03(\v2E.google.api.serviceusage.v1.BatchEnableServicesResponse.EnableFailureR\bfailures\x1aS\n" +
	"\rEnableFailure\x12\x1d\n" +
	"\n" +
	"service_id\x18\x01 \x01(\tR\tserviceId\x12#\n" +
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"G\n" +
	"\x17BatchGetServicesRequest\x12\x16\n" +
	"\x06parent\x18\x01 \x01(\tR\x06parent\x12\x14\n" +
	"\x05names\x18\x02 \x03(\tR\x05names\"[\n" +
	"\x18BatchGetServicesResponse\x12?\n" +
	"\bservices\x18\x01 \x03(\v2#.google.api.serviceusage.v1.ServiceR\bservices2\xe8\t\n" +
	"\fServiceUsage\x12\xba\x01\n" +
	"\rEnableService\x120.google.api.serviceusage.v1.EnableServiceRequest\x1a\x1d.google.longrunning.Operation\"X\xcaA*\n" +
	"\x15EnableServiceResponse\x12\x11OperationMetadata\x82\xd3\xe4\x93\x02%:\x01*\" /v1/{name=*/*/services/*}:enable\x12\xbe\x01\n" +
	"\x0eDisableService\x121.google.api.serviceusage.v1.DisableServiceRequest\x1a\x1d.google.longrunning.Operation\"Z\xcaA+\n" +
	"\x16DisableServiceResponse\x12\x11OperationMetadata\x82\xd3\xe4\x93\x02&:\x01*\"!/v1/{name=*/*/services/*}:disable\x12\x83\x01\n" +
	"\n" +
	...
	"\fListServices\x12/.google.api.serviceusage.v1.ListServicesRequest\x1a0.google.api.serviceusage.v1.ListServicesResponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/v1/{parent=*/*}/services\x12\xd1\x01\n" +
	...
	"\x1bBatchEnableServicesResponse\x12\x11OperationMetadata\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/{parent=*/*}/services:batchEnable\x12\xa9\x01\n" +
...
var (
	...
	file_google_api_serviceusage_v1_serviceusage_proto_rawDescData []byte
)
...
func file_google_api_serviceusage_v1_serviceusage_proto_rawDescGZIP() []byte {
	file_google_api_serviceusage_v1_serviceusage_proto_rawDescOnce.Do(func() {
		file_google_api_serviceusage_v1_serviceusage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_serviceusage_v1_serviceusage_proto_rawDesc), len(file_google_api_serviceusage_v1_serviceusage_proto_rawDesc)))
	})
...
func file_google_api_serviceusage_v1_serviceusage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_serviceusage_v1_serviceusage_proto_rawDesc), len(file_google_api_serviceusage_v1_serviceusage_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
