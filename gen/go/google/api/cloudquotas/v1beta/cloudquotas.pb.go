...
const file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDesc = "" +
	"\n" +
	...
	"\x16ListQuotaInfosResponse\x12I\n" +
	"\vquota_infos\x18\x01 \x03(\v2(.google.api.cloudquotas.v1beta.QuotaInfoR\n" +
	"quotaInfos\x12&\n" +
	...
	"\x1cListQuotaPreferencesResponse\x12[\n" +
	"\x11quota_preferences\x18\x01 \x03(\v2..google.api.cloudquotas.v1beta.QuotaPreferenceR\x10quotaPreferences\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12 \n" +
	"\vunreachable\x18\x03 \x03(\tR\vunreachable\"c\n" +
	"\x19GetQuotaPreferenceRequest\x12F\n" +
	"\x04name\x18\x01 \x01(\tB2\xe0A\x02\xfaA,\n" +
	"*cloudquotas.googleapis.com/QuotaPreferenceR\x04name\"\xe2\x02\n" +
	...
	"\x13quota_preference_id\x18\x02 \x01(\tB\x03\xe0A\x01R\x11quotaPreferenceId\x12^\n" +
	"\x10quota_preference\x18\x03 \x01(\v2..google.api.cloudquotas.v1beta.QuotaPreferenceB\x03\xe0A\x02R\x0fquotaPreference\x12a\n" +
	"\x14ignore_safety_checks\x18\x04 \x03(\x0e2/.google.api.cloudquotas.v1beta.QuotaSafetyCheckR\x12ignoreSafetyChecks\"\xf7\x02\n" +
	"\x1cUpdateQuotaPreferenceRequest\x12@\n" +
	"\vupdate_mask\x18\x01 \x01(\v2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x01R\n" +
	"updateMask\x12^\n" +
	"\x10quota_preference\x18\x02 \x01(\v2..google.api.cloudquotas.v1beta.QuotaPreferenceB\x03\xe0A\x02R\x0fquotaPreference\x12(\n" +
	"\rallow_missing\x18\x03 \x01(\bB\x03\xe0A\x01R\fallowMissing\x12(\n" +
	"\rvalidate_only\x18\x04 \x01(\bB\x03\xe0A\x01R\fvalidateOnly\x12a\n" +
	"\x14ignore_safety_checks\x18\x05 \x03(\x0e2/.google.api.cloudquotas.v1beta.QuotaSafetyCheckR\x12ignoreSafetyChecks2\xb1\x12\n" +
	"\vCloudQuotas\x12\xd5\x02\n" +
	"\x0eListQuotaInfos\x124.google.api.cloudquotas.v1beta.ListQuotaInfosRequest\x1a5.google.api.cloudquotas.v1beta.ListQuotaInfosResponse\"\xd5\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xc5\x01ZD\x12B/v1beta/{parent=organizations/*/locations/*/services/*}/quotaInfosZ>\x12</v1beta/{parent=folders/*/locations/*/services/*}/quotaInfos\x12=/v1beta/{parent=projects/*/locations/*/services/*}/quotaInfos\x12\xc2\x02\n" +
	"\fGetQuotaInfo\x122.google.api.cloudquotas.v1beta.GetQuotaInfoRequest\x1a(.google.api.cloudquotas.v1beta.QuotaInfo\"\xd3\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xc5\x01ZD\x12B/v1beta/{name=organizations/*/locations/*/services/*/quotaInfos/*}Z>\x12</v1beta/{name=folders/*/locations/*/services/*/quotaInfos/*}\x12=/v1beta/{name=projects/*/locations/*/services/*/quotaInfos/*}\x12\xd8\x02\n" +
	"\x14ListQuotaPreferences\x12:.google.api.cloudquotas.v1beta.ListQuotaPreferencesRequest\x1a;.google.api.cloudquotas.v1beta.ListQuotaPreferencesResponse\"\xc6\x01\xdaA\x06parent\x82\xd3\xe4\x93\x02\xb6\x01Z9\x127/v1beta/{parent=folders/*/locations/*}/quotaPreferencesZ?\x12=/v1beta/{parent=organizations/*/locations/*}/quotaPreferences\x128/v1beta/{parent=projects/*/locations/*}/quotaPreferences\x12\xc5\x02\n" +
	"\x12GetQuotaPreference\x128.google.api.cloudquotas.v1beta.GetQuotaPreferenceRequest\x1a..google.api.cloudquotas.v1beta.QuotaPreference\"\xc4\x01\xdaA\x04name\x82\xd3\xe4\x93\x02\xb6\x01Z?\x12=/v1beta/{name=organizations/*/locations/*/quotaPreferences/*}Z9\x127/v1beta/{name=folders/*/locations/*/quotaPreferences/*}\x128/v1beta/{name=projects/*/locations/*/quotaPreferences/*}\x12\xc2\x03\n" +
	"\x15CreateQuotaPreference\x12;.google.api.cloudquotas.v1beta.CreateQuotaPreferenceRequest\x1a..google.api.cloudquotas.v1beta.QuotaPreference\"\xbb\x02\xdaA+parent,quota_preference,quota_preference_id\xdaA\x17parent,quota_preference\x82\xd3\xe4\x93\x02\xec\x01:\x10quota_preferenceZK:\x10quota_preference\"7/v1beta/{parent=folders/*/locations/*}/quotaPreferencesZQ:\x10quota_preference\"=/v1beta/{parent=organizations/*/locations/*}/quotaPreferences\"8/v1beta/{parent=projects/*/locations/*}/quotaPreferences\x12\xcc\x03\n" +
	"\x15UpdateQuotaPreference\x12;.google.api.cloudquotas.v1beta.UpdateQuotaPreferenceRequest\x1a..google.api.cloudquotas.v1beta.QuotaPreference\"\xc5\x02\xdaA\x1cquota_preference,update_mask\x82\xd3\xe4\x93\x02\x9f\x02:\x10quota_preferenceZ\\:\x10quota_preference2H/v1beta/{quota_preference.name=folders/*/locations/*/quotaPreferences/*}Zb:\x10quota_preference2N/v1beta/{quota_preference.name=organizations/*/locations/*/quotaPreferences/*}2I/v1beta/{quota_preference.name=projects/*/locations/*/quotaPreferences/*}\x1aN\xcaA\x1acloudquotas.googleapis.com\xd2A.https://www.googleapis.com/auth/cloud-platformB\xf7\x04\xeaA\xe0\x01\n" +
	...
	"!com.google.api.cloudquotas.v1betaB\x10CloudquotasProtoP\x01ZEcloud.google.com/go/cloudquotas/apiv1beta/cloudquotaspb;cloudquotaspb\xaa\x02\x1fGoogle.Cloud.CloudQuotas.V1Beta\xca\x02\x1fGoogle\\Cloud\\CloudQuotas\\V1beta\xea\x02\"Google::Cloud::CloudQuotas::V1betab\x06proto3"

var (
	file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDescOnce sync.Once
	file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDescData []byte
)
...
func file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDescGZIP() []byte {
	file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDescOnce.Do(func() {
		file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDesc), len(file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDesc)))
	})
...
func file_google_api_cloudquotas_v1beta_cloudquotas_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDesc), len(file_google_api_cloudquotas_v1beta_cloudquotas_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
