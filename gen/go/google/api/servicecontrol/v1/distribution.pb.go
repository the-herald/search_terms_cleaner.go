...
func (x *Distribution) GetBucketOption() isDistribution_BucketOption {
	if x != nil {
		return x.BucketOption
	}
	return nil
}
...
func (x *Distribution) GetLinearBuckets() *Distribution_LinearBuckets {
	if x != nil {
		if x, ok := x.BucketOption.(*Distribution_LinearBuckets_); ok {
...
func (x *Distribution) GetExponentialBuckets() *Distribution_ExponentialBuckets {
	if x != nil {
		if x, ok := x.BucketOption.(*Distribution_ExponentialBuckets_); ok {
...
func (x *Distribution) GetExplicitBuckets() *Distribution_ExplicitBuckets {
	if x != nil {
		if x, ok := x.BucketOption.(*Distribution_ExplicitBuckets_); ok {
...
const file_google_api_servicecontrol_v1_distribution_proto_rawDesc = "" +
	"\n" +
	...
	"\amaximum\x18\x04 \x01(\x01R\amaximum\x127\n" +
	"\x18sum_of_squared_deviation\x18\x05 \x01(\x01R\x15sumOfSquaredDeviation\x12#\n" +
	"\rbucket_counts\x18\x06 \x03(\x03R\fbucketCounts\x12a\n" +
	"\x0elinear_buckets\x18\a \x01(\v28.google.api.servicecontrol.v1.Distribution.LinearBucketsH\x00R\rlinearBuckets\x12p\n" +
	"\x13exponential_buckets\x18\b \x01(\v2=.google.api.servicecontrol.v1.Distribution.ExponentialBucketsH\x00R\x12exponentialBuckets\x12g\n" +
	"\x10explicit_buckets\x18\t \x01(\v2:.google.api.servicecontrol.v1.Distribution.ExplicitBucketsH\x00R\x0fexplicitBuckets\x12?\n" +
	"\texemplars\x18\n" +
	" \x03(\v2!.google.api.Distribution.ExemplarR\texemplars\x1ak\n" +
	"\rLinearBuckets\x12,\n" +
...
var (
	...
	file_google_api_servicecontrol_v1_distribution_proto_rawDescData []byte
)
...
func file_google_api_servicecontrol_v1_distribution_proto_rawDescGZIP() []byte {
	file_google_api_servicecontrol_v1_distribution_proto_rawDescOnce.Do(func() {
		file_google_api_servicecontrol_v1_distribution_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_servicecontrol_v1_distribution_proto_rawDesc), len(file_google_api_servicecontrol_v1_distribution_proto_rawDesc)))
	})
...
var file_google_api_servicecontrol_v1_distribution_proto_goTypes = []any{
...
func file_google_api_servicecontrol_v1_distribution_proto_init() {
	...
	file_google_api_servicecontrol_v1_distribution_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_servicecontrol_v1_distribution_proto_rawDesc), len(file_google_api_servicecontrol_v1_distribution_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
