...
func (x *Rollout) GetStrategy() isRollout_Strategy {
	if x != nil {
		return x.Strategy
	}
	return nil
...
func (x *Rollout) GetTrafficPercentStrategy() *Rollout_TrafficPercentStrategy {
	if x != nil {
		if x, ok := x.Strategy.(*Rollout_TrafficPercentStrategy_); ok {
...
func (x *Rollout) GetDeleteServiceStrategy() *Rollout_DeleteServiceStrategy {
	if x != nil {
		if x, ok := x.Strategy.(*Rollout_DeleteServiceStrategy_); ok {
...
type Rollout_TrafficPercentStrategy struct {
	...
	Percentages   map[string]float64 `protobuf:"bytes,1,rep,name=percentages,proto3" json:"percentages,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"fixed64,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_google_api_servicemanagement_v1_resources_proto_rawDesc = "" +
	"\n" +
	...
	"\x05steps\x18\x02 \x03(\v27.google.api.servicemanagement.v1.OperationMetadata.StepR\x05steps\x12/\n" +
	"\x13progress_percentage\x18\x03 \x01(\x05R\x12progressPercentage\x129\n" +
	"\n" +
	"start_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x1a{\n" +
	"\x04Step\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12Q\n" +
	"\x06status\x18\x04 \x01(\x0e29.google.api.servicemanagement.v1.OperationMetadata.StatusR\x06status\"g\n" +
	"\x06Status\x12\x16\n" +
	...
	"\x04kind\x18\x02 \x01(\x0e20.google.api.servicemanagement.v1.Diagnostic.KindR\x04kind\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"\x1e\n" +
	"\x04Kind\x12\v\n" +
	"\aWARNING\x10\x00\x12\t\n" +
	"\x05ERROR\x10\x01\"a\n" +
	"\fConfigSource\x12\x0e\n" +
	"\x02id\x18\x05 \x01(\tR\x02id\x12A\n" +
	"\x05files\x18\x02 \x03(\v2+.google.api.servicemanagement.v1.ConfigFileR\x05files\"\xb7\x02\n" +
	"\n" +
	"ConfigFile\x12\x1b\n" +
	"\tfile_path\x18\x01 \x01(\tR\bfilePath\x12#\n" +
	"\rfile_contents\x18\x03 \x01(\fR\ffileContents\x12Q\n" +
	"\tfile_type\x18\x04 \x01(\x0e24.google.api.servicemanagement.v1.ConfigFile.FileTypeR\bfileType\"\x93\x01\n" +
	"\bFileType\x12\x19\n" +
	...
	"\fChangeReport\x12?\n" +
	"\x0econfig_changes\x18\x01 \x03(\v2\x18.google.api.ConfigChangeR\rconfigChanges\"\xf8\x06\n" +
	"\aRollout\x12\"\n" +
	"\n" +
	"rollout_id\x18\x01 \x01(\tB\x03\xe0A\x01R\trolloutId\x12;\n" +
	"\vcreate_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12\x1d\n" +
	"\n" +
	"created_by\x18\x03 \x01(\tR\tcreatedBy\x12N\n" +
	"\x06status\x18\x04 \x01(\x0e26.google.api.servicemanagement.v1.Rollout.RolloutStatusR\x06status\x12{\n" +
	"\x18traffic_percent_strategy\x18\x05 \x01(\v2?.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategyH\x00R\x16trafficPercentStrategy\x12y\n" +
	"\x17delete_service_strategy\x18\xc8\x01 \x01(\v2>.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategyH\x00R\x15deleteServiceStrategy\x12!\n" +
	"\fservice_name\x18\b \x01(\tR\vserviceName\x1a\xcc\x01\n" +
	"\x16TrafficPercentStrategy\x12r\n" +
	"\vpercentages\x18\x01 \x03(\v2P.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy.PercentagesEntryR\vpercentages\x1a>\n" +
	"\x10PercentagesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\x1a\x17\n" +
...
var (
	...
	file_google_api_servicemanagement_v1_resources_proto_rawDescData []byte
)
...
func file_google_api_servicemanagement_v1_resources_proto_rawDescGZIP() []byte {
	file_google_api_servicemanagement_v1_resources_proto_rawDescOnce.Do(func() {
		file_google_api_servicemanagement_v1_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_servicemanagement_v1_resources_proto_rawDesc), len(file_google_api_servicemanagement_v1_resources_proto_rawDesc)))
	})
...
var file_google_api_servicemanagement_v1_resources_proto_goTypes = []any{
...
func file_google_api_servicemanagement_v1_resources_proto_init() {
	...
	file_google_api_servicemanagement_v1_resources_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_servicemanagement_v1_resources_proto_rawDesc), len(file_google_api_servicemanagement_v1_resources_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
