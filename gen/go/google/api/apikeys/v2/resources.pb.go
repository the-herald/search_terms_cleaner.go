...
const file_google_api_apikeys_v2_resources_proto_rawDesc = "" +
	"\n" +
	"%google/api/apikeys/v2/resources.proto\x12\x15google.api.apikeys.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x96\x05\n" +
	"\x03Key\x12\x17\n" +
	...
	"deleteTime\x12M\n" +
	"\vannotations\x18\b \x03(\v2+.google.api.apikeys.v2.Key.AnnotationsEntryR\vannotations\x12G\n" +
	"\frestrictions\x18\t \x01(\v2#.google.api.apikeys.v2.RestrictionsR\frestrictions\x12\x17\n" +
	"\x04etag\x18\v \x01(\tB\x03\xe0A\x03R\x04etag\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:a\xeaA^\n" +
	"\x1aapikeys.googleapis.com/Key\x122projects/{project}/locations/{location}/keys/{key}*\x04keys2\x03keyR\x01\x01\"\x85\x04\n" +
	"\fRestrictions\x12i\n" +
	"\x18browser_key_restrictions\x18\x01 \x01(\v2-.google.api.apikeys.v2.BrowserKeyRestrictionsH\x00R\x16browserKeyRestrictions\x12f\n" +
	"\x17server_key_restrictions\x18\x02 \x01(\v2,.google.api.apikeys.v2.ServerKeyRestrictionsH\x00R\x15serverKeyRestrictions\x12i\n" +
	"\x18android_key_restrictions\x18\x03 \x01(\v2-.google.api.apikeys.v2.AndroidKeyRestrictionsH\x00R\x16androidKeyRestrictions\x12]\n" +
	"\x14ios_key_restrictions\x18\x04 \x01(\v2).google.api.apikeys.v2.IosKeyRestrictionsH\x00R\x12iosKeyRestrictions\x12A\n" +
	"\vapi_targets\x18\x05 \x03(\v2 .google.api.apikeys.v2.ApiTargetR\n" +
	"apiTargetsB\x15\n" +
	"\x13client_restrictions\"E\n" +
	"\x16BrowserKeyRestrictions\x12+\n" +
	"\x11allowed_referrers\x18\x01 \x03(\tR\x10allowedReferrers\"8\n" +
	"\x15ServerKeyRestrictions\x12\x1f\n" +
	"\vallowed_ips\x18\x01 \x03(\tR\n" +
	"allowedIps\"v\n" +
	"\x16AndroidKeyRestrictions\x12\\\n" +
	"\x14allowed_applications\x18\x01 \x03(\v2).google.api.apikeys.v2.AndroidApplicationR\x13allowedApplications\"b\n" +
	"\x12AndroidApplication\x12)\n" +
	"\x10sha1_fingerprint\x18\x01 \x01(\tR\x0fsha1Fingerprint\x12!\n" +
	"\fpackage_name\x18\x02 \x01(\tR\vpackageName\"B\n" +
	"\x12IosKeyRestrictions\x12,\n" +
	"\x12allowed_bundle_ids\x18\x01 \x03(\tR\x10allowedBundleIds\"D\n" +
	"\tApiTarget\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\x12\x1d\n" +
	"\amethods\x18\x02 \x03(\tB\x03\xe0A\x01R\amethodsB\xb5\x01\n" +
...
var (
	...
	file_google_api_apikeys_v2_resources_proto_rawDescData []byte
)
...
func file_google_api_apikeys_v2_resources_proto_rawDescGZIP() []byte {
	file_google_api_apikeys_v2_resources_proto_rawDescOnce.Do(func() {
		file_google_api_apikeys_v2_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_api_apikeys_v2_resources_proto_rawDesc), len(file_google_api_apikeys_v2_resources_proto_rawDesc)))
	})
...
func file_google_api_apikeys_v2_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_api_apikeys_v2_resources_proto_rawDesc), len(file_google_api_apikeys_v2_resources_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
