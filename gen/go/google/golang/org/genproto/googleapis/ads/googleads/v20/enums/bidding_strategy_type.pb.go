...
func (BiddingStrategyTypeEnum_BiddingStrategyType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_enumTypes[0].Descriptor()
}

func (BiddingStrategyTypeEnum_BiddingStrategyType) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_enumTypes[0]
}
...
func (BiddingStrategyTypeEnum_BiddingStrategyType) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BiddingStrategyTypeEnum) Reset() {
	*x = BiddingStrategyTypeEnum{}
	mi := &file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_msgTypes[0]
...
func (*BiddingStrategyTypeEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v20_enums_bidding_strategy_type_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDesc = "" +
	"\n" +
...
var (
	file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDesc), len(file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDescData
}

var file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_goTypes = []any{
	(BiddingStrategyTypeEnum_BiddingStrategyType)(0), // 0: google.ads.googleads.v20.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	(*BiddingStrategyTypeEnum)(nil),                  // 1: google.ads.googleads.v20.enums.BiddingStrategyTypeEnum
}
var file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_init() }
func file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_init() {
	if File_google_ads_googleads_v20_enums_bidding_strategy_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDesc), len(file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_enums_bidding_strategy_type_proto = out.File
	file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_goTypes = nil
	file_google_ads_googleads_v20_enums_bidding_strategy_type_proto_depIdxs = nil
}
