...
func (x *AndroidPrivacySharedKeyGoogleAdGroup) Reset() {
	*x = AndroidPrivacySharedKeyGoogleAdGroup{}
	mi := &file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes[0]
...
func (*AndroidPrivacySharedKeyGoogleAdGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc = "" +
	"\n" +
...
var (
	file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc), len(file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData
}

var file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_goTypes = []any{
	(*AndroidPrivacySharedKeyGoogleAdGroup)(nil),                               // 0: google.ads.googleads.v20.resources.AndroidPrivacySharedKeyGoogleAdGroup
...
var file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v20.resources.AndroidPrivacySharedKeyGoogleAdGroup.android_privacy_interaction_type:type_name -> google.ads.googleads.v20.enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType
	2, // 1: google.ads.googleads.v20.resources.AndroidPrivacySharedKeyGoogleAdGroup.android_privacy_network_type:type_name -> google.ads.googleads.v20.enums.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType
...
func init() {
	file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_init()
}
func file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_init() {
	if File_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc), len(file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto = out.File
	file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_goTypes = nil
	file_google_ads_googleads_v20_resources_android_privacy_shared_key_google_ad_group_proto_depIdxs = nil
}
