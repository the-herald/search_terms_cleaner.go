...
type ShoppingProduct struct {
	...
	Channel enums.ProductChannelEnum_ProductChannel `protobuf:"varint,3,opt,name=channel,proto3,enum=google.ads.googleads.v20.enums.ProductChannelEnum_ProductChannel" json:"channel,omitempty"`
	...
	// merchant.
	ChannelExclusivity *enums.ProductChannelExclusivityEnum_ProductChannelExclusivity `protobuf:"varint,12,opt,name=channel_exclusivity,json=channelExclusivity,proto3,enum=google.ads.googleads.v20.enums.ProductChannelExclusivityEnum_ProductChannelExclusivity,oneof" json:"channel_exclusivity,omitempty"`
	// Output only. The condition of the product as provided by the merchant.
	Condition *enums.ProductConditionEnum_ProductCondition `protobuf:"varint,13,opt,name=condition,proto3,enum=google.ads.googleads.v20.enums.ProductConditionEnum_ProductCondition,oneof" json:"condition,omitempty"`
	// Output only. The availability of the product as provided by the merchant.
	Availability *enums.ProductAvailabilityEnum_ProductAvailability `protobuf:"varint,14,opt,name=availability,proto3,enum=google.ads.googleads.v20.enums.ProductAvailabilityEnum_ProductAvailability,oneof" json:"availability,omitempty"`
	...
	Status enums.ProductStatusEnum_ProductStatus `protobuf:"varint,32,opt,name=status,proto3,enum=google.ads.googleads.v20.enums.ProductStatusEnum_ProductStatus" json:"status,omitempty"`
...
func (x *ShoppingProduct) Reset() {
	*x = ShoppingProduct{}
	mi := &file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[0]
...
func (*ShoppingProduct) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescGZIP(), []int{0}
}
...
type ShoppingProduct_ProductIssue struct {
	...
	AdsSeverity enums.ProductIssueSeverityEnum_ProductIssueSeverity `protobuf:"varint,2,opt,name=ads_severity,json=adsSeverity,proto3,enum=google.ads.googleads.v20.enums.ProductIssueSeverityEnum_ProductIssueSeverity" json:"ads_severity,omitempty"`
...
func (x *ShoppingProduct_ProductIssue) Reset() {
	*x = ShoppingProduct_ProductIssue{}
	mi := &file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ShoppingProduct_ProductIssue) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_google_ads_googleads_v20_resources_shopping_product_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_resources_shopping_product_proto_rawDesc = "" +
	"\n" +
	...
	"\achannel\x18\x03 \x01(\x0e2A.google.ads.googleads.v20.enums.ProductChannelEnum.ProductChannelB\x03\xe0A\x03R\achannel\x12(\n" +
	...
	"\x13channel_exclusivity\x18\f \x01(\x0e2W.google.ads.googleads.v20.enums.ProductChannelExclusivityEnum.ProductChannelExclusivityB\x03\xe0A\x03H\x05R\x12channelExclusivity\x88\x01\x01\x12m\n" +
	"\tcondition\x18\r \x01(\x0e2E.google.ads.googleads.v20.enums.ProductConditionEnum.ProductConditionB\x03\xe0A\x03H\x06R\tcondition\x88\x01\x01\x12y\n" +
	"\favailability\x18\x0e \x01(\x0e2K.google.ads.googleads.v20.enums.ProductAvailabilityEnum.ProductAvailabilityB\x03\xe0A\x03H\aR\favailability\x88\x01\x01\x12.\n" +
	...
	"\x06status\x18  \x01(\x0e2?.google.ads.googleads.v20.enums.ProductStatusEnum.ProductStatusB\x03\xe0A\x03R\x06status\x12]\n" +
	"\x06issues\x18! \x03(\v2@.google.ads.googleads.v20.resources.ShoppingProduct.ProductIssueB\x03\xe0A\x03R\x06issues\x12J\n" +
	...
	"\fads_severity\x18\x02 \x01(\x0e2M.google.ads.googleads.v20.enums.ProductIssueSeverityEnum.ProductIssueSeverityB\x03\xe0A\x03R\vadsSeverity\x12/\n" +
...
var (
	file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_shopping_product_proto_rawDesc), len(file_google_ads_googleads_v20_resources_shopping_product_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_resources_shopping_product_proto_rawDescData
}

var file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v20_resources_shopping_product_proto_goTypes = []any{
	(*ShoppingProduct)(nil),                                            // 0: google.ads.googleads.v20.resources.ShoppingProduct
	(*ShoppingProduct_ProductIssue)(nil),                               // 1: google.ads.googleads.v20.resources.ShoppingProduct.ProductIssue
	(enums.ProductChannelEnum_ProductChannel)(0),                       // 2: google.ads.googleads.v20.enums.ProductChannelEnum.ProductChannel
	(enums.ProductChannelExclusivityEnum_ProductChannelExclusivity)(0), // 3: google.ads.googleads.v20.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity
	(enums.ProductConditionEnum_ProductCondition)(0),                   // 4: google.ads.googleads.v20.enums.ProductConditionEnum.ProductCondition
	(enums.ProductAvailabilityEnum_ProductAvailability)(0),             // 5: google.ads.googleads.v20.enums.ProductAvailabilityEnum.ProductAvailability
	(enums.ProductStatusEnum_ProductStatus)(0),                         // 6: google.ads.googleads.v20.enums.ProductStatusEnum.ProductStatus
	(enums.ProductIssueSeverityEnum_ProductIssueSeverity)(0),           // 7: google.ads.googleads.v20.enums.ProductIssueSeverityEnum.ProductIssueSeverity
}
var file_google_ads_googleads_v20_resources_shopping_product_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v20.resources.ShoppingProduct.channel:type_name -> google.ads.googleads.v20.enums.ProductChannelEnum.ProductChannel
	3, // 1: google.ads.googleads.v20.resources.ShoppingProduct.channel_exclusivity:type_name -> google.ads.googleads.v20.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity
	4, // 2: google.ads.googleads.v20.resources.ShoppingProduct.condition:type_name -> google.ads.googleads.v20.enums.ProductConditionEnum.ProductCondition
	5, // 3: google.ads.googleads.v20.resources.ShoppingProduct.availability:type_name -> google.ads.googleads.v20.enums.ProductAvailabilityEnum.ProductAvailability
	6, // 4: google.ads.googleads.v20.resources.ShoppingProduct.status:type_name -> google.ads.googleads.v20.enums.ProductStatusEnum.ProductStatus
	1, // 5: google.ads.googleads.v20.resources.ShoppingProduct.issues:type_name -> google.ads.googleads.v20.resources.ShoppingProduct.ProductIssue
	7, // 6: google.ads.googleads.v20.resources.ShoppingProduct.ProductIssue.ads_severity:type_name -> google.ads.googleads.v20.enums.ProductIssueSeverityEnum.ProductIssueSeverity
...
func init() { file_google_ads_googleads_v20_resources_shopping_product_proto_init() }
func file_google_ads_googleads_v20_resources_shopping_product_proto_init() {
	if File_google_ads_googleads_v20_resources_shopping_product_proto != nil {
		return
	}
	file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_shopping_product_proto_rawDesc), len(file_google_ads_googleads_v20_resources_shopping_product_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_resources_shopping_product_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_resources_shopping_product_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_resources_shopping_product_proto = out.File
	file_google_ads_googleads_v20_resources_shopping_product_proto_goTypes = nil
	file_google_ads_googleads_v20_resources_shopping_product_proto_depIdxs = nil
}
