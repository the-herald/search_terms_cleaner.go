...
type AccountBudget struct {
	...
	Status enums.AccountBudgetStatusEnum_AccountBudgetStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v20.enums.AccountBudgetStatusEnum_AccountBudgetStatus" json:"status,omitempty"`
...
func (x *AccountBudget) Reset() {
	*x = AccountBudget{}
	mi := &file_google_ads_googleads_v20_resources_account_budget_proto_msgTypes[0]
...
func (*AccountBudget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_resources_account_budget_proto_rawDescGZIP(), []int{0}
}
...
type AccountBudget_ApprovedEndTimeType struct {
	...
	// FOREVER.
	ApprovedEndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,11,opt,name=approved_end_time_type,json=approvedEndTimeType,proto3,enum=google.ads.googleads.v20.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudget_ProposedSpendingLimitType struct {
	...
	// example, INFINITE.
	ProposedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,13,opt,name=proposed_spending_limit_type,json=proposedSpendingLimitType,proto3,enum=google.ads.googleads.v20.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudget_ApprovedSpendingLimitType struct {
	...
	// limit is INFINITE.
	ApprovedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,15,opt,name=approved_spending_limit_type,json=approvedSpendingLimitType,proto3,enum=google.ads.googleads.v20.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudget_AdjustedSpendingLimitType struct {
	...
	AdjustedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,17,opt,name=adjusted_spending_limit_type,json=adjustedSpendingLimitType,proto3,enum=google.ads.googleads.v20.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudget_PendingAccountBudgetProposal struct {
	...
	ProposalType enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType `protobuf:"varint,2,opt,name=proposal_type,json=proposalType,proto3,enum=google.ads.googleads.v20.enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType" json:"proposal_type,omitempty"`
...
func (x *AccountBudget_PendingAccountBudgetProposal) Reset() {
	*x = AccountBudget_PendingAccountBudgetProposal{}
	mi := &file_google_ads_googleads_v20_resources_account_budget_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountBudget_PendingAccountBudgetProposal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_resources_account_budget_proto_rawDescGZIP(), []int{0, 0}
}
...
type AccountBudget_PendingAccountBudgetProposal_EndTimeType struct {
	...
	EndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,6,opt,name=end_time_type,json=endTimeType,proto3,enum=google.ads.googleads.v20.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudget_PendingAccountBudgetProposal_SpendingLimitType struct {
	...
	// INFINITE.
	SpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,8,opt,name=spending_limit_type,json=spendingLimitType,proto3,enum=google.ads.googleads.v20.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
var File_google_ads_googleads_v20_resources_account_budget_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_resources_account_budget_proto_rawDesc = "" +
	"\n" +
	...
	"\x06status\x18\x04 \x01(\x0e2K.google.ads.googleads.v20.enums.AccountBudgetStatusEnum.AccountBudgetStatusB\x03\xe0A\x03R\x06status\x12\x1c\n" +
	...
	"\x10pending_proposal\x18\x16 \x01(\v2N.google.ads.googleads.v20.resources.AccountBudget.PendingAccountBudgetProposalB\x03\xe0A\x03R\x0fpendingProposal\x12:\n" +
	"\x16proposed_end_date_time\x18\x1c \x01(\tB\x03\xe0A\x03H\x00R\x13proposedEndDateTime\x12q\n" +
	"\x16proposed_end_time_type\x18\t \x01(\x0e25.google.ads.googleads.v20.enums.TimeTypeEnum.TimeTypeB\x03\xe0A\x03H\x00R\x13proposedEndTimeType\x12:\n" +
	"\x16approved_end_date_time\x18\x1d \x01(\tB\x03\xe0A\x03H\x01R\x13approvedEndDateTime\x12q\n" +
	"\x16approved_end_time_type\x18\v \x01(\x0e25.google.ads.googleads.v20.enums.TimeTypeEnum.TimeTypeB\x03\xe0A\x03H\x01R\x13approvedEndTimeType\x12J\n" +
	"\x1eproposed_spending_limit_micros\x18\x1e \x01(\x03B\x03\xe0A\x03H\x02R\x1bproposedSpendingLimitMicros\x12\x8f\x01\n" +
	"\x1cproposed_spending_limit_type\x18\r \x01(\x0e2G.google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitTypeB\x03\xe0A\x03H\x02R\x19proposedSpendingLimitType\x12J\n" +
	"\x1eapproved_spending_limit_micros\x18\x1f \x01(\x03B\x03\xe0A\x03H\x03R\x1bapprovedSpendingLimitMicros\x12\x8f\x01\n" +
	"\x1capproved_spending_limit_type\x18\x0f \x01(\x0e2G.google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitTypeB\x03\xe0A\x03H\x03R\x19approvedSpendingLimitType\x12J\n" +
	"\x1eadjusted_spending_limit_micros\x18  \x01(\x03B\x03\xe0A\x03H\x04R\x1badjustedSpendingLimitMicros\x12\x8f\x01\n" +
	"\x1cadjusted_spending_limit_type\x18\x11 \x01(\x0e2G.google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitTypeB\x03\xe0A\x03H\x04R\x19adjustedSpendingLimitType\x1a\xd7\a\n" +
	...
	"\rproposal_type\x18\x02 \x01(\x0e2W.google.ads.googleads.v20.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalTypeB\x03\xe0A\x03R\fproposalType\x12\x1c\n" +
	...
	"\rend_time_type\x18\x06 \x01(\x0e25.google.ads.googleads.v20.enums.TimeTypeEnum.TimeTypeB\x03\xe0A\x03H\x00R\vendTimeType\x129\n" +
	"\x15spending_limit_micros\x18\x10 \x01(\x03B\x03\xe0A\x03H\x01R\x13spendingLimitMicros\x12~\n" +
	"\x13spending_limit_type\x18\b \x01(\x0e2G.google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitTypeB\x03\xe0A\x03H\x01R\x11spendingLimitTypeB\n" +
	"\n" +
	"\bend_timeB\x10\n" +
...
var (
	file_google_ads_googleads_v20_resources_account_budget_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_resources_account_budget_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_resources_account_budget_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_resources_account_budget_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_resources_account_budget_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_account_budget_proto_rawDesc), len(file_google_ads_googleads_v20_resources_account_budget_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_resources_account_budget_proto_rawDescData
}

var file_google_ads_googleads_v20_resources_account_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v20_resources_account_budget_proto_goTypes = []any{
	(*AccountBudget)(nil),                                              // 0: google.ads.googleads.v20.resources.AccountBudget
	(*AccountBudget_PendingAccountBudgetProposal)(nil),                 // 1: google.ads.googleads.v20.resources.AccountBudget.PendingAccountBudgetProposal
	(enums.AccountBudgetStatusEnum_AccountBudgetStatus)(0),             // 2: google.ads.googleads.v20.enums.AccountBudgetStatusEnum.AccountBudgetStatus
	...
	(enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType)(0), // 5: google.ads.googleads.v20.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
}
var file_google_ads_googleads_v20_resources_account_budget_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v20.resources.AccountBudget.status:type_name -> google.ads.googleads.v20.enums.AccountBudgetStatusEnum.AccountBudgetStatus
	1,  // 1: google.ads.googleads.v20.resources.AccountBudget.pending_proposal:type_name -> google.ads.googleads.v20.resources.AccountBudget.PendingAccountBudgetProposal
	3,  // 2: google.ads.googleads.v20.resources.AccountBudget.proposed_end_time_type:type_name -> google.ads.googleads.v20.enums.TimeTypeEnum.TimeType
	3,  // 3: google.ads.googleads.v20.resources.AccountBudget.approved_end_time_type:type_name -> google.ads.googleads.v20.enums.TimeTypeEnum.TimeType
	4,  // 4: google.ads.googleads.v20.resources.AccountBudget.proposed_spending_limit_type:type_name -> google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitType
	4,  // 5: google.ads.googleads.v20.resources.AccountBudget.approved_spending_limit_type:type_name -> google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitType
	4,  // 6: google.ads.googleads.v20.resources.AccountBudget.adjusted_spending_limit_type:type_name -> google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitType
	5,  // 7: google.ads.googleads.v20.resources.AccountBudget.PendingAccountBudgetProposal.proposal_type:type_name -> google.ads.googleads.v20.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	3,  // 8: google.ads.googleads.v20.resources.AccountBudget.PendingAccountBudgetProposal.end_time_type:type_name -> google.ads.googleads.v20.enums.TimeTypeEnum.TimeType
	4,  // 9: google.ads.googleads.v20.resources.AccountBudget.PendingAccountBudgetProposal.spending_limit_type:type_name -> google.ads.googleads.v20.enums.SpendingLimitTypeEnum.SpendingLimitType
...
func init() { file_google_ads_googleads_v20_resources_account_budget_proto_init() }
func file_google_ads_googleads_v20_resources_account_budget_proto_init() {
	if File_google_ads_googleads_v20_resources_account_budget_proto != nil {
		return
	}
	file_google_ads_googleads_v20_resources_account_budget_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_google_ads_googleads_v20_resources_account_budget_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_account_budget_proto_rawDesc), len(file_google_ads_googleads_v20_resources_account_budget_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_resources_account_budget_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_resources_account_budget_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v20_resources_account_budget_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_resources_account_budget_proto = out.File
	file_google_ads_googleads_v20_resources_account_budget_proto_goTypes = nil
	file_google_ads_googleads_v20_resources_account_budget_proto_depIdxs = nil
}
