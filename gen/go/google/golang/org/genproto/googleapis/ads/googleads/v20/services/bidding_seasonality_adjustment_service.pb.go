...
func (x *MutateBiddingSeasonalityAdjustmentsRequest) Reset() {
	*x = MutateBiddingSeasonalityAdjustmentsRequest{}
	mi := &file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes[0]
...
func (*MutateBiddingSeasonalityAdjustmentsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *BiddingSeasonalityAdjustmentOperation) Reset() {
	*x = BiddingSeasonalityAdjustmentOperation{}
	mi := &file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BiddingSeasonalityAdjustmentOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateBiddingSeasonalityAdjustmentsResponse) Reset() {
	*x = MutateBiddingSeasonalityAdjustmentsResponse{}
	mi := &file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBiddingSeasonalityAdjustmentsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBiddingSeasonalityAdjustmentsResult) Reset() {
	*x = MutateBiddingSeasonalityAdjustmentsResult{}
	mi := &file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBiddingSeasonalityAdjustmentsResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12m\n" +
	"\n" +
	"operations\x18\x02 \x03(\v2H.google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentOperationB\x03\xe0A\x02R\n" +
	"operations\x12'\n" +
	"\x0fpartial_failure\x18\x03 \x01(\bR\x0epartialFailure\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\x12\x7f\n" +
	"\x15response_content_type\x18\x05 \x01(\x0e2K.google.ads.googleads.v20.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\xff\x02\n" +
	"%BiddingSeasonalityAdjustmentOperation\x12;\n" +
	"\vupdate_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12Z\n" +
	"\x06create\x18\x01 \x01(\v2@.google.ads.googleads.v20.resources.BiddingSeasonalityAdjustmentH\x00R\x06create\x12Z\n" +
	"\x06update\x18\x02 \x01(\v2@.google.ads.googleads.v20.resources.BiddingSeasonalityAdjustmentH\x00R\x06update\x12T\n" +
	...
	"\aresults\x18\x02 \x03(\v2L.google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResultR\aresults\"\x95\x02\n" +
	...
	"\x1ebidding_seasonality_adjustment\x18\x02 \x01(\v2@.google.ads.googleads.v20.resources.BiddingSeasonalityAdjustmentR\x1cbiddingSeasonalityAdjustment2\x9c\x03\n" +
	"#BiddingSeasonalityAdjustmentService\x12\xad\x02\n" +
	"#MutateBiddingSeasonalityAdjustments\x12M.google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsRequest\x1aN.google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResponse\"g\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02H:\x01*\"C/v20/customers/{customer_id=*}/biddingSeasonalityAdjustments:mutate\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x94\x02\n" +
...
var (
	file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDesc), len(file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDescData
}

var file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_goTypes = []any{
	(*MutateBiddingSeasonalityAdjustmentsRequest)(nil),     // 0: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsRequest
	(*BiddingSeasonalityAdjustmentOperation)(nil),          // 1: google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentOperation
	(*MutateBiddingSeasonalityAdjustmentsResponse)(nil),    // 2: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResponse
	(*MutateBiddingSeasonalityAdjustmentsResult)(nil),      // 3: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResult
	...
	(*resources.BiddingSeasonalityAdjustment)(nil),         // 6: google.ads.googleads.v20.resources.BiddingSeasonalityAdjustment
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsRequest.operations:type_name -> google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentOperation
	4, // 1: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsRequest.response_content_type:type_name -> google.ads.googleads.v20.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentOperation.create:type_name -> google.ads.googleads.v20.resources.BiddingSeasonalityAdjustment
	6, // 4: google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentOperation.update:type_name -> google.ads.googleads.v20.resources.BiddingSeasonalityAdjustment
	7, // 5: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResponse.results:type_name -> google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResult
	6, // 7: google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResult.bidding_seasonality_adjustment:type_name -> google.ads.googleads.v20.resources.BiddingSeasonalityAdjustment
	0, // 8: google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments:input_type -> google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsRequest
	2, // 9: google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments:output_type -> google.ads.googleads.v20.services.MutateBiddingSeasonalityAdjustmentsResponse
...
func file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_init() {
	if File_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto != nil {
		return
	}
	file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDesc), len(file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto = out.File
	file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_goTypes = nil
	file_google_ads_googleads_v20_services_bidding_seasonality_adjustment_service_proto_depIdxs = nil
}
