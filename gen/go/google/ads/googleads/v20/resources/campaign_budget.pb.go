...
type CampaignBudget struct {
	...
	Status enums.BudgetStatusEnum_BudgetStatus `protobuf:"varint,6,opt,name=status,proto3,enum=google.ads.googleads.v20.enums.BudgetStatusEnum_BudgetStatus" json:"status,omitempty"`
	...
	// specified.
	Period enums.BudgetPeriodEnum_BudgetPeriod `protobuf:"varint,13,opt,name=period,proto3,enum=google.ads.googleads.v20.enums.BudgetPeriodEnum_BudgetPeriod" json:"period,omitempty"`
...
func (x *CampaignBudget) Reset() {
	*x = CampaignBudget{}
	mi := &file_google_ads_googleads_v20_resources_campaign_budget_proto_msgTypes[0]
...
func (*CampaignBudget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v20_resources_campaign_budget_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDesc = "" +
	"\n" +
	...
	"\x06period\x18\r \x01(\x0e2=.google.ads.googleads.v20.enums.BudgetPeriodEnum.BudgetPeriodB\x03\xe0A\x05R\x06period\x12q\n" +
	...
	"\x04type\x18\x12 \x01(\x0e29.google.ads.googleads.v20.enums.BudgetTypeEnum.BudgetTypeB\x03\xe0A\x05R\x04type\x12=\n" +
...
var (
	file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDesc), len(file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDescData
}

var file_google_ads_googleads_v20_resources_campaign_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v20_resources_campaign_budget_proto_goTypes = []any{
	(*CampaignBudget)(nil),                                   // 0: google.ads.googleads.v20.resources.CampaignBudget
	(enums.BudgetStatusEnum_BudgetStatus)(0),                 // 1: google.ads.googleads.v20.enums.BudgetStatusEnum.BudgetStatus
	(enums.BudgetDeliveryMethodEnum_BudgetDeliveryMethod)(0), // 2: google.ads.googleads.v20.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod
	(enums.BudgetPeriodEnum_BudgetPeriod)(0),                 // 3: google.ads.googleads.v20.enums.BudgetPeriodEnum.BudgetPeriod
	(enums.BudgetTypeEnum_BudgetType)(0),                     // 4: google.ads.googleads.v20.enums.BudgetTypeEnum.BudgetType
}
var file_google_ads_googleads_v20_resources_campaign_budget_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v20.resources.CampaignBudget.status:type_name -> google.ads.googleads.v20.enums.BudgetStatusEnum.BudgetStatus
	2, // 1: google.ads.googleads.v20.resources.CampaignBudget.delivery_method:type_name -> google.ads.googleads.v20.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod
	3, // 2: google.ads.googleads.v20.resources.CampaignBudget.period:type_name -> google.ads.googleads.v20.enums.BudgetPeriodEnum.BudgetPeriod
	4, // 3: google.ads.googleads.v20.resources.CampaignBudget.type:type_name -> google.ads.googleads.v20.enums.BudgetTypeEnum.BudgetType
...
func init() { file_google_ads_googleads_v20_resources_campaign_budget_proto_init() }
func file_google_ads_googleads_v20_resources_campaign_budget_proto_init() {
	if File_google_ads_googleads_v20_resources_campaign_budget_proto != nil {
		return
	}
	file_google_ads_googleads_v20_resources_campaign_budget_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDesc), len(file_google_ads_googleads_v20_resources_campaign_budget_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_resources_campaign_budget_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_resources_campaign_budget_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v20_resources_campaign_budget_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_resources_campaign_budget_proto = out.File
	file_google_ads_googleads_v20_resources_campaign_budget_proto_goTypes = nil
	file_google_ads_googleads_v20_resources_campaign_budget_proto_depIdxs = nil
}
