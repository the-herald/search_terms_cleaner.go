...
func file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDesc), len(file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDesc)))
	})
...
var file_google_ads_googleads_v20_resources_shared_criterion_proto_goTypes = []any{
	(*SharedCriterion)(nil),                    // 0: google.ads.googleads.v20.resources.SharedCriterion
...
func file_google_ads_googleads_v20_resources_shared_criterion_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDesc), len(file_google_ads_googleads_v20_resources_shared_criterion_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
