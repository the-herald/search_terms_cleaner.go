...
func (x *LocationSet) Reset() {
	*x = LocationSet{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[0]
...
func (*LocationSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{0}
}
...
func (x *BusinessProfileLocationSet) Reset() {
	*x = BusinessProfileLocationSet{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BusinessProfileLocationSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{1}
}
...
type ChainSet struct {
	...
	// advertiser.
	RelationshipType enums.ChainRelationshipTypeEnum_ChainRelationshipType `protobuf:"varint,1,opt,name=relationship_type,json=relationshipType,proto3,enum=google.ads.googleads.v20.enums.ChainRelationshipTypeEnum_ChainRelationshipType" json:"relationship_type,omitempty"`
...
func (x *ChainSet) Reset() {
	*x = ChainSet{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{2}
}
...
func (x *ChainFilter) Reset() {
	*x = ChainFilter{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{3}
}
...
func (x *MapsLocationSet) Reset() {
	*x = MapsLocationSet{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MapsLocationSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{4}
}
...
func (x *MapsLocationInfo) Reset() {
	*x = MapsLocationInfo{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MapsLocationInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{5}
}
...
func (x *BusinessProfileLocationGroup) Reset() {
	*x = BusinessProfileLocationGroup{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BusinessProfileLocationGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{6}
}
...
func (x *DynamicBusinessProfileLocationGroupFilter) Reset() {
	*x = DynamicBusinessProfileLocationGroupFilter{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DynamicBusinessProfileLocationGroupFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{7}
}
...
type BusinessProfileBusinessNameFilter struct {
	...
	FilterType    enums.LocationStringFilterTypeEnum_LocationStringFilterType `protobuf:"varint,2,opt,name=filter_type,json=filterType,proto3,enum=google.ads.googleads.v20.enums.LocationStringFilterTypeEnum_LocationStringFilterType" json:"filter_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BusinessProfileBusinessNameFilter) Reset() {
	*x = BusinessProfileBusinessNameFilter{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BusinessProfileBusinessNameFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{8}
}
...
func (x *ChainLocationGroup) Reset() {
	*x = ChainLocationGroup{}
	mi := &file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainLocationGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP(), []int{9}
}
...
var File_google_ads_googleads_v20_common_asset_set_types_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_common_asset_set_types_proto_rawDesc = "" +
	"\n" +
	...
	"\x17location_ownership_type\x18\x03 \x01(\x0e2O.google.ads.googleads.v20.enums.LocationOwnershipTypeEnum.LocationOwnershipTypeB\x06\xe0A\x02\xe0A\x05R\x15locationOwnershipType\x12\x80\x01\n" +
	"\x1dbusiness_profile_location_set\x18\x01 \x01(\v2;.google.ads.googleads.v20.common.BusinessProfileLocationSetH\x00R\x1abusinessProfileLocationSet\x12Y\n" +
	"\x12chain_location_set\x18\x02 \x01(\v2).google.ads.googleads.v20.common.ChainSetH\x00R\x10chainLocationSet\x12^\n" +
	"\x11maps_location_set\x18\x05 \x01(\v20.google.ads.googleads.v20.common.MapsLocationSetH\x00R\x0fmapsLocationSetB\b\n" +
	"\x06source\"\xc5\x02\n" +
	...
	"\x11relationship_type\x18\x01 \x01(\x0e2O.google.ads.googleads.v20.enums.ChainRelationshipTypeEnum.ChainRelationshipTypeB\x06\xe0A\x02\xe0A\x05R\x10relationshipType\x12I\n" +
	"\x06chains\x18\x02 \x03(\v2,.google.ads.googleads.v20.common.ChainFilterB\x03\xe0A\x02R\x06chains\"^\n" +
	...
	"\x0emaps_locations\x18\x01 \x03(\v21.google.ads.googleads.v20.common.MapsLocationInfoB\x03\xe0A\x02R\rmapsLocations\"-\n" +
	"\x10MapsLocationInfo\x12\x19\n" +
	"\bplace_id\x18\x01 \x01(\tR\aplaceId\"\xce\x01\n" +
	"\x1cBusinessProfileLocationGroup\x12\xad\x01\n" +
	".dynamic_business_profile_location_group_filter\x18\x01 \x01(\v2J.google.ads.googleads.v20.common.DynamicBusinessProfileLocationGroupFilterR)dynamicBusinessProfileLocationGroupFilter\"\x92\x02\n" +
	")DynamicBusinessProfileLocationGroupFilter\x12#\n" +
	"\rlabel_filters\x18\x01 \x03(\tR\flabelFilters\x12y\n" +
	"\x14business_name_filter\x18\x02 \x01(\v2B.google.ads.googleads.v20.common.BusinessProfileBusinessNameFilterH\x00R\x12businessNameFilter\x88\x01\x01\x12,\n" +
	...
	"\vfilter_type\x18\x02 \x01(\x0e2U.google.ads.googleads.v20.enums.LocationStringFilterTypeEnum.LocationStringFilterTypeR\n" +
	"filterType\"\x92\x01\n" +
	"\x12ChainLocationGroup\x12|\n" +
	"$dynamic_chain_location_group_filters\x18\x01 \x03(\v2,.google.ads.googleads.v20.common.ChainFilterR dynamicChainLocationGroupFiltersB\xf2\x01\n" +
...
var (
	file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_common_asset_set_types_proto_rawDesc), len(file_google_ads_googleads_v20_common_asset_set_types_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_common_asset_set_types_proto_rawDescData
}

var file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_google_ads_googleads_v20_common_asset_set_types_proto_goTypes = []any{
	(*LocationSet)(nil),                                              // 0: google.ads.googleads.v20.common.LocationSet
	(*BusinessProfileLocationSet)(nil),                               // 1: google.ads.googleads.v20.common.BusinessProfileLocationSet
	(*ChainSet)(nil),                                                 // 2: google.ads.googleads.v20.common.ChainSet
	(*ChainFilter)(nil),                                              // 3: google.ads.googleads.v20.common.ChainFilter
	(*MapsLocationSet)(nil),                                          // 4: google.ads.googleads.v20.common.MapsLocationSet
	(*MapsLocationInfo)(nil),                                         // 5: google.ads.googleads.v20.common.MapsLocationInfo
	(*BusinessProfileLocationGroup)(nil),                             // 6: google.ads.googleads.v20.common.BusinessProfileLocationGroup
	(*DynamicBusinessProfileLocationGroupFilter)(nil),                // 7: google.ads.googleads.v20.common.DynamicBusinessProfileLocationGroupFilter
	(*BusinessProfileBusinessNameFilter)(nil),                        // 8: google.ads.googleads.v20.common.BusinessProfileBusinessNameFilter
	(*ChainLocationGroup)(nil),                                       // 9: google.ads.googleads.v20.common.ChainLocationGroup
	(enums.LocationOwnershipTypeEnum_LocationOwnershipType)(0),       // 10: google.ads.googleads.v20.enums.LocationOwnershipTypeEnum.LocationOwnershipType
	(enums.ChainRelationshipTypeEnum_ChainRelationshipType)(0),       // 11: google.ads.googleads.v20.enums.ChainRelationshipTypeEnum.ChainRelationshipType
	(enums.LocationStringFilterTypeEnum_LocationStringFilterType)(0), // 12: google.ads.googleads.v20.enums.LocationStringFilterTypeEnum.LocationStringFilterType
}
var file_google_ads_googleads_v20_common_asset_set_types_proto_depIdxs = []int32{
	10, // 0: google.ads.googleads.v20.common.LocationSet.location_ownership_type:type_name -> google.ads.googleads.v20.enums.LocationOwnershipTypeEnum.LocationOwnershipType
	1,  // 1: google.ads.googleads.v20.common.LocationSet.business_profile_location_set:type_name -> google.ads.googleads.v20.common.BusinessProfileLocationSet
	2,  // 2: google.ads.googleads.v20.common.LocationSet.chain_location_set:type_name -> google.ads.googleads.v20.common.ChainSet
	4,  // 3: google.ads.googleads.v20.common.LocationSet.maps_location_set:type_name -> google.ads.googleads.v20.common.MapsLocationSet
	11, // 4: google.ads.googleads.v20.common.ChainSet.relationship_type:type_name -> google.ads.googleads.v20.enums.ChainRelationshipTypeEnum.ChainRelationshipType
	3,  // 5: google.ads.googleads.v20.common.ChainSet.chains:type_name -> google.ads.googleads.v20.common.ChainFilter
	5,  // 6: google.ads.googleads.v20.common.MapsLocationSet.maps_locations:type_name -> google.ads.googleads.v20.common.MapsLocationInfo
	7,  // 7: google.ads.googleads.v20.common.BusinessProfileLocationGroup.dynamic_business_profile_location_group_filter:type_name -> google.ads.googleads.v20.common.DynamicBusinessProfileLocationGroupFilter
	8,  // 8: google.ads.googleads.v20.common.DynamicBusinessProfileLocationGroupFilter.business_name_filter:type_name -> google.ads.googleads.v20.common.BusinessProfileBusinessNameFilter
	12, // 9: google.ads.googleads.v20.common.BusinessProfileBusinessNameFilter.filter_type:type_name -> google.ads.googleads.v20.enums.LocationStringFilterTypeEnum.LocationStringFilterType
	3,  // 10: google.ads.googleads.v20.common.ChainLocationGroup.dynamic_chain_location_group_filters:type_name -> google.ads.googleads.v20.common.ChainFilter
...
func init() { file_google_ads_googleads_v20_common_asset_set_types_proto_init() }
func file_google_ads_googleads_v20_common_asset_set_types_proto_init() {
	if File_google_ads_googleads_v20_common_asset_set_types_proto != nil {
		return
	}
	file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[0].OneofWrappers = []any{
		(*LocationSet_BusinessProfileLocationSet)(nil),
		(*LocationSet_ChainLocationSet)(nil),
		(*LocationSet_MapsLocationSet)(nil),
	}
	file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_common_asset_set_types_proto_rawDesc), len(file_google_ads_googleads_v20_common_asset_set_types_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_common_asset_set_types_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_common_asset_set_types_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v20_common_asset_set_types_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_common_asset_set_types_proto = out.File
	file_google_ads_googleads_v20_common_asset_set_types_proto_goTypes = nil
	file_google_ads_googleads_v20_common_asset_set_types_proto_depIdxs = nil
}
