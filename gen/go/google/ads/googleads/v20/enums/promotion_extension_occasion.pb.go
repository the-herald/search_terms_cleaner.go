...
func (PromotionExtensionOccasionEnum_PromotionExtensionOccasion) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_enumTypes[0].Descriptor()
}

func (PromotionExtensionOccasionEnum_PromotionExtensionOccasion) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_enumTypes[0]
}
...
func (PromotionExtensionOccasionEnum_PromotionExtensionOccasion) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PromotionExtensionOccasionEnum) Reset() {
	*x = PromotionExtensionOccasionEnum{}
	mi := &file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_msgTypes[0]
...
func (*PromotionExtensionOccasionEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v20_enums_promotion_extension_occasion_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDesc = "" +
	"\n" +
...
var (
	file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDesc), len(file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDescData
}

var file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_goTypes = []any{
	(PromotionExtensionOccasionEnum_PromotionExtensionOccasion)(0), // 0: google.ads.googleads.v20.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion
	(*PromotionExtensionOccasionEnum)(nil),                         // 1: google.ads.googleads.v20.enums.PromotionExtensionOccasionEnum
}
var file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_init() }
func file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_init() {
	if File_google_ads_googleads_v20_enums_promotion_extension_occasion_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDesc), len(file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_enums_promotion_extension_occasion_proto = out.File
	file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_goTypes = nil
	file_google_ads_googleads_v20_enums_promotion_extension_occasion_proto_depIdxs = nil
}
