...
func file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDesc), len(file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDesc)))
	})
...
var file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_goTypes = []any{
	(CampaignSharedSetStatusEnum_CampaignSharedSetStatus)(0), // 0: google.ads.googleads.v20.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
	(*CampaignSharedSetStatusEnum)(nil),                      // 1: google.ads.googleads.v20.enums.CampaignSharedSetStatusEnum
}
...
func file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDesc), len(file_google_ads_googleads_v20_enums_campaign_shared_set_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
