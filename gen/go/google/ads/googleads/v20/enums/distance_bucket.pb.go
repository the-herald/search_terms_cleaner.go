...
func (DistanceBucketEnum_DistanceBucket) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v20_enums_distance_bucket_proto_enumTypes[0].Descriptor()
}

func (DistanceBucketEnum_DistanceBucket) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v20_enums_distance_bucket_proto_enumTypes[0]
}
...
func (DistanceBucketEnum_DistanceBucket) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *DistanceBucketEnum) Reset() {
	*x = DistanceBucketEnum{}
	mi := &file_google_ads_googleads_v20_enums_distance_bucket_proto_msgTypes[0]
...
func (*DistanceBucketEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v20_enums_distance_bucket_proto protoreflect.FileDescriptor

const file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDesc = "" +
	"\n" +
	...
	"\"com.google.ads.googleads.v20.enumsB\x13DistanceBucketProtoP\x01ZCgoogle.golang.org/genproto/googleapis/ads/googleads/v20/enums;enums\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V20.Enums\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V20\\Enums\xea\x02\"Google::Ads::GoogleAds::V20::Enumsb\x06proto3"

var (
	file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescData []byte
)

func file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDesc), len(file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDesc)))
	})
	return file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDescData
}

var file_google_ads_googleads_v20_enums_distance_bucket_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v20_enums_distance_bucket_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v20_enums_distance_bucket_proto_goTypes = []any{
	(DistanceBucketEnum_DistanceBucket)(0), // 0: google.ads.googleads.v20.enums.DistanceBucketEnum.DistanceBucket
	(*DistanceBucketEnum)(nil),             // 1: google.ads.googleads.v20.enums.DistanceBucketEnum
}
var file_google_ads_googleads_v20_enums_distance_bucket_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v20_enums_distance_bucket_proto_init() }
func file_google_ads_googleads_v20_enums_distance_bucket_proto_init() {
	if File_google_ads_googleads_v20_enums_distance_bucket_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDesc), len(file_google_ads_googleads_v20_enums_distance_bucket_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v20_enums_distance_bucket_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v20_enums_distance_bucket_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v20_enums_distance_bucket_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v20_enums_distance_bucket_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v20_enums_distance_bucket_proto = out.File
	file_google_ads_googleads_v20_enums_distance_bucket_proto_goTypes = nil
	file_google_ads_googleads_v20_enums_distance_bucket_proto_depIdxs = nil
}
